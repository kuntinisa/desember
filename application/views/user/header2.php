                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                         ...
                         <li>
                            <a href = "<?php echo base_url(); ?>biodata"><i class="fa fa-dashboard fa-fw"></i> Biodata</a>
                        </li>
                         <li>
                            <a href = "<?php echo base_url(); ?>dashboard/template"><i class="fa fa-dashboard fa-fw"></i> Template</a>
                        </li>
                         <li>
                            <a href = "<?php echo base_url(); ?>eprofile"><i class="fa fa-dashboard fa-fw"></i> Profile Online Saya</a>
                        </li>
