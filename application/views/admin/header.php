            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href = "<?php echo base_url(); ?>admin/myuser"><i class="fa fa-table fa-fw"></i> My User</a>
                        </li>
                        <li>
                            <a href = "<?php echo base_url(); ?>admin/myfeedbacks"><i class="fa fa-edit fa-fw"></i> My Feedbacks</a>
                        </li>
