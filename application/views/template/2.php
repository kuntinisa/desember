...
<div class="col-sm-4 col-md-3 sidebar">
         ...
         foreach ($personal as $a) {
           echo $a->nama_depan." ".$a->nama_belakang; ?></h1> 
			 <img src="<?php echo base_url(); ?>assets/template/2/images/avt.png" alt=""/>
		 </div>
		<div class="details">
...
<div class="col-sm-8 col-sm-offset-4 col-md-9 col-md-offset-3 main">
	 <div class="content">
		 ...
		 <div class="copywrite">
			 <p>© 2017 My Profile VIP All Rights Reseverd | Design by <a href="<?php echo base_url(); ?>assets/template/2/http://w3layouts.com/" target="_blank">W3layouts</a> </p>
		 </div>
	 </div>
</div>
<!---->
