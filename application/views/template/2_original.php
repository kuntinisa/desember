...
<div class="col-sm-3 col-md-2 sidebar">
		...
		<div class="details">
			 ...
			 <p>+00 234 56 789</p>  	 
			 <h3>EMAIL</h3>
			 <p><a href="<?php echo base_url(); ?>assets/template/2/mailto@example.com">mail@example.com</a></p>
			 <address>
			 <h3>ADDRESS</h3>
...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
	 <div class="content">
		 ...
		 <div class="copywrite">
			 <p>© 2015 Curriculum Vitae All Rights Reseverd | Design by <a href="<?php echo base_url(); ?>assets/template/2/http://w3layouts.com/" target="_blank">W3layouts</a> </p>
		 </div>
	 </div>
</div>
<!---->
