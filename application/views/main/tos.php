    ...
    <body id="body">
        ...
        ==================================== -->
			...
			<!-- Service section -->
			<section id="service" style="margin-top: 5%">
				<div class="container">
					TERMS OF SERVICE					
...
Your use of this website and any dispute arising out of such use of the website is subject to the laws of England, Northern Ireland, Scotland and Wales.				</div>
			</section>
			<!-- end Service section -->
			<!-- 
