...
<body>
    <!-- ******HEADER****** --> 
     <!-- <a href = "<?php echo base_url();?>dashboard/choose/4"><button  class="btn btn-success">Use this</button></a> -->
    <header class="header">
        <div class="container">                       
         ...
         foreach ($personal as $a) {
           echo $a->nama_depan." ".$a->nama_belakang; } ?></h1>
            ...
            <!-- <a class="btn btn-cta-primary pull-right" href = "<?php echo base_url();?>dashboard/choose/4"> target="_blank"><i class="fa fa-paper-plane"></i> Action for this</a>             -->
             <a class="btn btn-cta-primary pull-right" href = "<?php echo base_url();?>dashboard/choose/4"><i class="fa fa-paper-plane"></i>Use this template</a>      
        </div><!--//container-->
    </header><!--//header-->
